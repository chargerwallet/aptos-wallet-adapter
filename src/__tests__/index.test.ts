import { ChargerwalletWallet } from "../index";

/*
Basic tests to make sure basic variables and functions are defined on the wallet

Note: change ChargerwalletWallet to match your class name
*/
describe("ChargerwalletWallet", () => {
  const wallet = new ChargerwalletWallet();
